package emitters {
	...
	public class Explosion extends Entity {
		...
		public function Explosion(_x:Number, _y:Number, color:uint, amount:int, maxDist:int = 50) {
			super();
			posx = _x;
			posy = _y;
			_amount = amount;
			...
			explosionEmitter.setMotion("explode", 0, maxDist, maxDist * (1 / 25), 360, -maxDist / 2 + 1, maxDist * (1 / 25) - 0.5, Ease.quadOut);
